...
! Tak Yamaguchi 2015/10: RADAEROS
	...
	REAL(KIND=kind_rb), DIMENSION(:,:), ALLOCATABLE, SAVE :: &
        ...
        real, dimension(nx, ny)      :: lwntxy = 0., lwntcxy = 0., lwnsxy = 0., lwnscxy = 0., lwdsxy = 0.,  &
             swntxy = 0., swntcxy = 0., swnsxy = 0., swnscxy = 0., swdsxy = 0. ! Instantaneous long- and short-wave radiative fluxes (W/m2)  
