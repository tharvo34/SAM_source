module micro_params
  ...
  integer, public :: acttransferoption = 0 ! flavor of aitken to accumulation mode transfer on activation
  ...
  ! modify aerosol when performing a branch restart (i.e., nrestart = 2)
  logical, public :: do_rescale_aerosol_on_branch_restart = .false.
  real, public :: Naccum_scale_factor_branch_restart = 1.
  real, public :: Qaccum_scale_factor_branch_restart = 1.
  real, public :: Naitken_scale_factor_branch_restart = 1.
  real, public :: Qaitken_scale_factor_branch_restart = 1.
  ...
  integer :: nmicro_proc
  integer, parameter :: nmicro_process_rates = 110  ! 74 + 21 + 8 new ones for activation + 6 new aerosol limiters
  ...
  character(len=8), dimension(nmicro_process_rates), parameter, public :: &
       ...
       'QADPOSLM', & !  pos limiting accumulation aerosol mass mixing ratio
       'QADNEGLM', & !  neg limiting accumulation aerosol mass mixing ratio
       'NAKPOSLM', & !  pos limiting Aitken aerosol number
       'NAKNEGLM', & !  neg limiting Aitken aerosol number
       'QAKPOSLM', & !  pos limiting Aitken aerosol mass mixing ratio
       'QAKNEGLM', & !  neg limiting Aitken aerosol mass mixing ratio
  ...
  character(len=80), dimension(nmicro_process_rates), parameter, public :: &
       ...
       'QADPOSLM, CHANGE IN ACCUMULATION AEROSOL MASS DUE TO POS LIMITER                ', &
       'QADNEGLM, CHANGE IN ACCUMULATION AEROSOL MASS DUE TO NEG LIMITER                ', &
       'NAKPOSLM, CHANGE IN AITKEN AEROSOL NUMBER DUE TO POS LIMITER                    ', &
       'NAKNEGLM, CHANGE IN AITKEN AEROSOL NUMBER DUE TO NEG LIMITER                    ', &
       'QAKPOSLM, CHANGE IN AITKEN AEROSOL MASS DUE TO POS LIMITER                      ', &
       'QAKNEGLM, CHANGE IN AITKEN AEROSOL MASS DUE TO NEG LIMITER                      ', &
       'NSUBI   , LOSS OF NI DURING SUB.                                                ', &
       'NSUBS   , LOSS OF NS DURING SUB.                                                ', &
       'PRD     , DEP CLOUD ICE                                                         ', &
       'PRDS    , DEP SNOW                                                              ', &
