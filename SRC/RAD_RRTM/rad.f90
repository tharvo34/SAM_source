module rad
  ...
  use params, only : ggr, coszrs, cp, ocean,  &
       ...
       ocean_flux_option !bloss(2021-08): Adding ocean_flux_option
  ...
  use vars, only : t, tabs, qv, qcl, qci, qpl, sstxy, tskinxy, rho, t00, & !bloss(2021-08): added tskinxy
       latitude, longitude,                         &
  ...
  public :: qrad, radqrcsw, radqrclw, &
       ...
       swntxy, swntcxy, swnsxy, swnscxy, swdsxy, & ! instantaneous radiative fluxes at surface and TOA
       lwntxy, lwntcxy, lwnsxy, lwnscxy, lwdsxy, &
  ...
  real, dimension(nx, ny)      :: lwntxy, lwntcxy, lwnsxy, lwnscxy, lwdsxy, &
                                  swntxy, swntcxy, swnsxy, swnscxy, swdsxy ! Instantaneous long- and short-wave radiative fluxes (W/m2)  
	...
	! set trace gas concentrations.  Assumed to be uniform in the horizontal.
        ...
        do lat = 1, ny 
          ...
          if(ocean_flux_option.eq.36) then
            !bloss(2021-08): Use cool skin temperature from COARE3.6 scheme.
            interfaceT(:, 1)  = tskinxy(1:nx, lat) 
          end if
      ...
      ! Downward fluxes at surface
      lwdsxy(:, :) = lwDownSurface(:, :) ! LW downward at Surface
      swdsxy(:, :) = swDownSurface(:, :) ! SW downward at Surface
